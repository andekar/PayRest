#
# Be sure to run `pod lib lint PayRest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/PayRest.git", :tag => s.version.to_s }
